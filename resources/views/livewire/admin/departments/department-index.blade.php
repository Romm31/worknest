<div>
    ...
    <x-ui.card :padding="false">
            ...
            <table class="table">
                ...
                <tbody>
                    @forelse($departments as $department)
                        <tr>
                            <td>
                                <span class="font-mono text-xs bg-slate-100 dark:bg-zinc-700 px-2 py-1 rounded">
                                    {{ $department->code }}
                                </span>
                            </td>
        ...
        @if($departments->hasPages())
            <div class="px-6 py-4 border-t border-slate-200 dark:border-zinc-700">
                {{ $departments->links() }}
            </div>
        @endif
    </x-ui.card>
                        ...
                        <div class="p-6 space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" wire:model="code"
                                    ...
                                    placeholder="e.g., HR" maxlength="10">
        ...
        <div class="fixed inset-0 z-50 overflow-y-auto">
            <div class="flex min-h-full items-center justify-center p-4">
                ...
                <div class="relative w-full max-w-sm bg-white dark:bg-zinc-800 rounded-xl shadow-2xl p-6 text-center">
                    ...
                    <h3 class="text-lg font-semibold text-slate-900 dark:text-zinc-100 mb-2">Delete Department</h3>
                    <p class="text-sm text-slate-500 dark:text-zinc-400 mb-6">
                        Are you sure you want to delete this department? This action cannot be undone.
                    </p>
                    <div class="flex justify-center gap-3">
                        <x-ui.button type="button" wire:click="$set('showDeleteModal', false)" variant="secondary">
                            Cancel
                        </x-ui.button>
                        <x-ui.button type="button" wire:click="delete" variant="danger" wire:loading.attr="disabled">
